...
export const Reactions = ({ data, onChange }: ReactionsProps) => {
  ...
  const reactionsMarkup = data.map((reaction) => {
    const isCurrentMember = reaction.memberIds.includes(currentMemberId);
    return (
      <Hint
        key={reaction._id}
      ...
      >
        <button
          ...
          className={cn(
            ...
            isCurrentMember && "bg-blue-100/70 border-blue-500 text-white"
          )}
        >
          {reaction.value}
          <span
